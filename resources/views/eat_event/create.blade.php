...
@section('page-wrapper')
    ...
    <form action="{{ url('makan-gratis/store') }}" enctype="multipart/form-data" method="post">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="">
                                <option value="1">Aktif (Sudah bisa mendaftar)</option>
            ...
            <div class="col-md-5 col-lg-5 col-sm-12">
                <div class="card">
                    <img
                        ...
                        class="card-img-top img-fluid" src="https://i.stack.imgur.com/y9DpT.jpg" alt="Card image cap">
                    <div class="card-body">
