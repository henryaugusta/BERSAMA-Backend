...
@section('page-breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Manage EVENT</h4>
...
@section('page-wrapper')
    ...
    <div class="card border-primary">
        <div class="card-header bg-primary">
            <h4 class="mb-0 text-white">Manage Event Makan Gratis</h4>
        </div>
        <div class="card-body">
                ...
                <table id="table_data" class="table table-hover table-bordered display no-wrap" style="width:100%">
                    ...
                    @forelse ($datas as $data)
                        <tr>
                            ...
                            <td>{{ $data->name }}</td>
                            <td>{{ $data->offline_quotas}}</td>
                            <td>{{ $data->online_quotas}}</td>
