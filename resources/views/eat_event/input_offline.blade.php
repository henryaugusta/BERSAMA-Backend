...
@section('page-wrapper')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action='{{ url("makan-gratis/$data->id/input-offline/store") }}' enctype="multipart/form-data" method="post">
                        @csrf
                        <h3 class="card-title">Input Peserta Offline</h3>
        ...
        <div class="col-lg-12 col-md-12 col-lg-23 col-sm-12">
            <div class="card border-primary">
                <div class="card-header bg-primary">
                    <h4 class="mb-0 text-white">Pendaftar Offline</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table_data" class="table table-hover table-bordered display no-wrap"
                            ...
                            @forelse ($offline_takers as $data)
                                <tr>
                                    ...
                                    @if(Auth::user()->role=="1")
                                        <td>
                                            <a href="{{url('makan-gratis/input-offline'.'/'.$data->id.'/destroy')}}">
        ...
        <div class="col-lg-12 col-md-12 col-lg-23 col-sm-12">
            <div class="card border-primary">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table_dataz" class="table table-hover table-bordered display no-wrap"
                               style="width:100%">
                            <thead class="">
                            <tr>
                                <th data-sortable="">No</th>
                                ...
                                <th data-sortable="">Waktu Pengambilan</th>
                                <th data-sortable="">Tandai Sudah Diambil</th>
                            ...
                            @forelse ($participants as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('makan-gratis/participants'.'/'.$data->id.'/updateTaken')}}">
                                            <button type="button" class="btn btn-outline-primary">UPDATE MENJADI SUDAH DIAMBIL</button>
                                        </a>
                                    </td>
                                    <td>
        ...
        $(function () {
            var table = $('#table_data').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'excelHtml5',
                        title: 'Data OFFLINE {{ \Carbon\Carbon::now()->year }}'
                    },
                    'csvHtml5',
                ],
            ...
            var table = $('#table_dataz').DataTable({
                processing: true,
                serverSide: false,
                columnDefs: [{
                    orderable: true,
                ...
                buttons: [
                    ...
                    {
                        extend: 'excelHtml5',
                        title: 'Data ONLINE {{ \Carbon\Carbon::now()->year }}'
                    },
                    'csvHtml5',
                ],
