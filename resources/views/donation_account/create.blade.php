...
@section('page-breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Akun Donasi</h4>
...
@section('page-wrapper')
    ...
    <form action="{{ url('donation-account/store') }}" enctype="multipart/form-data" method="post">
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Tambah Data Akun/Rekening/Alamat Tujuan Donasi</h3>
                        ...
                        <div class="form-group">
                            <label for="basicInput">Jenis Merchant</label>
                            <select class="form-control" name="merchant_id" id="" required>
                        ...
                        <div class="form-group">
                            <label for="basicInput">Nama Pemilik Akun</label>
